...
urlpatterns = [
    path(
        ...
        RedirectView.as_view(
            url=staticfiles_storage.url('images/AssignMate_icon.png'),
        ),
    ),
    path(
        '',
    ...
    path(
        'tag/<str:tag_slug>/',
         views.homework_list,
        name='homework_list_by_tag',
    ),
    path(
        '<int:year>/<int:month>/<int:day>/<str:homework_slug>/',
         views.homework_detail,
         name='homework_detail',
    ),
    path(
        '<int:homework_id>/share/',
         views.homework_share,
        name='homework_share',
    ),
    path(
        '<int:homework_id>/comment/',
    ...
    path(
        'solution/delete/<int:solution_id>/',
    ...
    path(
        'homework/<int:homework_id>/delete/',
        views.delete_homework,
        name='delete_homework',
    ),
    path(
        'homework/<int:solution_id>/review/',
